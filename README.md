...
> 2021 年 9 月 15 日更新。大家一定要计划好时间，最近工作比较麻烦，所以工作中很难静下心来学习，回到家也懒得学习，这么下去的话，时间肯定是不够的，希望大家可以继续坚持一段时间。

- 先快速过了一遍希赛的第四版教材，耗时一周
- 看视频，重学标记的重、难点知识点（目前只看了一部分，针对不懂得再看，会的就不看了，其实后面也懒得看视频了）
- 然后同时开始关注案例和论文，看真题、其他人的模板以及极客时间的架构课程（此时只是了解即可，回想自己过往做过和参与过的项目，一定手抄模拟一下考试的感觉，看看自己的手速等）
- 然后我其实就开始专项训练了，基本清楚了每一章的考试内容，出题风格是怎样的（目前已经刷了一遍专项，第二遍也快结束了，重点针对错题和没记住的知识点）
...
- 真题训练（有时间和精力的多做几遍，其实此时主要是案例和论文了，综合应该是差不多了，剩下的背背知识点吧），卡点，不懂的搞懂，形成个人习惯，保证做题速度和正确率
- 复盘总结，路上或者平常不忙的时候，可以拿出手机用 app 来刷题巩固。一定要有好心态，坚持
...
这里提供一个希赛官方的[真题集锦](https://www.educity.cn/rk/zhenti/jiagou/)，有网页版，也可以下载 pdf 版本。不过只有 09-18 年的（页面里 20 年的下载下来还是 18 年的），大家可以自行下载打印，也可以用我整理的（已经放在真题文件夹），或者直接运行我写的下载脚本（仅支持 Unix/Linux 系统）。

`$ ./download.sh`

### 公开真题吧

这里在提供一个[真题链接](https://www.gkzenti.cn/paper)，仅仅是网页版的，排版质量还不错，可以参考。希赛资源里 18 年的案例和 17 的综合排版有些问题，可以用这个来看，也是只有 09-18 年的，后面有时间可以写个脚本抓取网页并转存为 pdf，不过暂且不需要了，嘿嘿。
